...
void I2C_init(){
 ...
 SSP2CON2 = 0x00;
    SSP2CON3 = 0x00;
 SSP2ADD = ((4000000/(4UL*100000UL))-1);
}

void I2C_start(void){

    SSP2CON2bits.SEN = 1;
    while((SSP2CON2bits.SEN == 1)&&(auxRTC<100)){
        auxRTC++;
    }
    auxRTC=0;
}
...
void I2C_restart(void){
    ...
    SSP2CON2bits.RSEN = 1;
    while((SSP2CON2bits.RSEN == 1)&&(auxRTC<100)){
        auxRTC++;
    }
    auxRTC=0;
}
...
void I2C_stop(void){
    ...
    SSP2CON2bits.PEN = 1;
    while((SSP2CON2bits.PEN == 1)&&(auxRTC<100)){
        auxRTC++;
    }
    auxRTC=0;
}
...
char I2C_read(void){
    ...
    PIR3bits.SSP2IF = 0;
    SSP2CON2bits.RCEN = 1;
    while((PIR3bits.SSP2IF == 0)&&(auxRTC<100)){
        auxRTC++;
    }
    auxRTC=0;
